...
public class particleID {
    ...
    public static Particle_ID_Histo histo;
    ...
    public static void main( String[] args ) throws FileNotFoundException, IOException {
        ...
        histo     = new Particle_ID_Histo();
        histo.setOutputDir(inputParam.getOutputDir());
    ...
    TCanvas ec4 = new TCanvas("Positive Plots",1500,1500);
    histo.drawPositives(ec4);
